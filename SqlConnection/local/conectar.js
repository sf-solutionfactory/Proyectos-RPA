...
GLOBAL.step( {
	Custom: function (ev, sc, st) {
		...
		var adCmdText = 1;
		var strConnectionString = "Provider:'SQLOLEDB';driver: 'SQL Server';server:'192.168.32.207\\WEBSERVICES';database:'SCHDEV';user:'pagos';password:'Zotaku(3524,g20'";

		function GetConnection() {
			var oConnection = null;
			try {
				oConnection = new ActiveXObject("ADODB.Connection");
				ctx.log('Connection: ' + strConnectionString);
