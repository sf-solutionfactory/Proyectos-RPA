...
* @var NoAttendedLicence No license to run attended jobs.
* @var ConcurrentQuotaReached Maximum number of concurrent attended execution reached. Cannot add job.
* @var NoUnattendedLicence No license to run unattended jobs.
*/
e.error = {
  None : '',
  OK : 'OK',
  ...
  TimeOut : 'TimeOut',
  Canceled : 'Canceled',
  NoAttendedLicence: 'NoAttendedLicence',
  ConcurrentQuotaReached:'ConcurrentQuotaReached',
  NoUnattendedLicence:'NoUnattendedLicence'
}
...
* @enum {number}
* @path e.priority
* @var lowest Low priority (old name)
* @var low Low priority
* @var normal Normal priority (old name)
* @var medium Normal priority
* @var high High priority
* @var highest Very High priority (old name)
* @var veryhigh Very High priority
* @readonly
*/
e.priority = {
  lowest : 0,
