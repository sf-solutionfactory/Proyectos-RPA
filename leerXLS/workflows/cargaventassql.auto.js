...
// ----------------------------------------------------------------
GLOBAL.scenario({ cargaVentasSQL: function(ev, sc) {
...
}}, ctx.dataManagers.rootData).setId('1abe1288-dd5b-4d43-a52d-6e201c1025fd') ;
...
//   Step: formaLista
// ----------------------------------------------------------------
GLOBAL.step({ formaLista: function(ev, sc, st) {
	var rootData = sc.data;
