...
// ----------------------------------------------------------------
GLOBAL.scenario({ carga_SAP_EntradaDiaria: function(ev, sc) {
	...
	sc.step(GLOBAL.steps.pSalirDelSistema_mana_3, null);
}}, ctx.dataManagers.rootData).setId('ccb5342f-7efd-4166-9770-e3c685bc102a') ;

// ----------------------------------------------------------------
//   Step: getSettingsEE
// ----------------------------------------------------------------
GLOBAL.step({ getSettingsEE: function(ev, sc, st) {
	var rootData = sc.data;
	// Declares a setting
...
//   Step: getFilenameEE
// ----------------------------------------------------------------
GLOBAL.step({ getFilenameEE: function(ev, sc, st) {
	var rootData = sc.data;
...
//   Step: Read_txtEE
// ----------------------------------------------------------------
GLOBAL.step({ Read_txtEE: function(ev, sc, st) {
	var rootData = sc.data;
...
//   Step: Write_txtEE
// ----------------------------------------------------------------
GLOBAL.step({ Write_txtEE: function(ev, sc, st) {
	var rootData = sc.data;
...
// ----------------------------------------------------------------
GLOBAL.step({ Start_SAPLogon750EE: function(ev, sc, st) {
	var rootData = sc.data;
...
// ----------------------------------------------------------------
GLOBAL.step({ pWindowSAPLogon75_man_3: function(ev, sc, st) {
	var rootData = sc.data;
...
// ----------------------------------------------------------------
GLOBAL.step({ Declare_credentiaLEE: function(ev, sc, st) {
	var rootData = sc.data;
...
// ----------------------------------------------------------------
GLOBAL.step({ Get_credentialEE: function(ev, sc, st) {
	var rootData = sc.data;
...
// ----------------------------------------------------------------
GLOBAL.step({ pSAPLogin_managementE: function(ev, sc, st) {
	var rootData = sc.data;
...
// ----------------------------------------------------------------
GLOBAL.step({ pSAPEasyAccess_manage_4: function(ev, sc, st) {
	var rootData = sc.data;
...
// ----------------------------------------------------------------
GLOBAL.step({ Disable_step_timeoutE: function(ev, sc, st) {
	var rootData = sc.data;
...
// ----------------------------------------------------------------
GLOBAL.step({ pVentasYFacturasMas_m_4: function(ev, sc, st) {
	var rootData = sc.data;
...
// ----------------------------------------------------------------
GLOBAL.step({ pPosDocumVisualiza_ma_3: function(ev, sc, st) {
	var rootData = sc.data;
...
// ----------------------------------------------------------------
GLOBAL.step({ pVentasYFacturasMas_m_1_3: function(ev, sc, st) {
	var rootData = sc.data;
...
// ----------------------------------------------------------------
GLOBAL.step({ pSAPEasyAccess_manage_1_3: function(ev, sc, st) {
	var rootData = sc.data;
...
// ----------------------------------------------------------------
GLOBAL.step({ pSalirDelSistema_mana_3: function(ev, sc, st) {
	var rootData = sc.data;
