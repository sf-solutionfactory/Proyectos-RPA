...
// ----------------------------------------------------------------
GLOBAL.scenario({ carga_SAP_Lunes: function(ev, sc) {
	...
	sc.step(GLOBAL.steps.Start_SAPLogon750LL, GLOBAL.steps.pWindowSAPLogon75_man_1);
	sc.step(GLOBAL.steps.pWindowSAPLogon75_man_1, GLOBAL.steps.Declare_credentialLL);
	...
	sc.step(GLOBAL.steps.pSAPLogin_managementL, GLOBAL.steps.pSAPEasyAccess_manage_2);
	sc.step(GLOBAL.steps.pSAPEasyAccess_manage_2, GLOBAL.steps.Disable_step_timeoutL);
	sc.step(GLOBAL.steps.Disable_step_timeoutL, GLOBAL.steps.pVentasYFacturasMas_m_2);
...
//   Step: getSettingsLL
// ----------------------------------------------------------------
GLOBAL.step({ getSettingsLL: function(ev, sc, st) {
	var rootData = sc.data;
	// Declares a setting
...
//   Step: getFilenameLL
// ----------------------------------------------------------------
GLOBAL.step({ getFilenameLL: function(ev, sc, st) {
	var rootData = sc.data;
...
//   Step: Read_txtLL
// ----------------------------------------------------------------
GLOBAL.step({ Read_txtLL: function(ev, sc, st) {
	var rootData = sc.data;
...
//   Step: setListLL
// ----------------------------------------------------------------
GLOBAL.step({ setListLL: function(ev, sc, st) {
	var rootData = sc.data;
...
//   Step: Write_txtLL
// ----------------------------------------------------------------
GLOBAL.step({ Write_txtLL: function(ev, sc, st) {
	var rootData = sc.data;
...
// ----------------------------------------------------------------
GLOBAL.step({ Start_SAPLogon750LL: function(ev, sc, st) {
	var rootData = sc.data;
...
// ----------------------------------------------------------------
GLOBAL.step({ Declare_credentialLL: function(ev, sc, st) {
	var rootData = sc.data;
...
// ----------------------------------------------------------------
GLOBAL.step({ Get_credentialLL: function(ev, sc, st) {
	var rootData = sc.data;
...
// ----------------------------------------------------------------
GLOBAL.step({ pSAPLogin_managementL: function(ev, sc, st) {
	var rootData = sc.data;
...
// ----------------------------------------------------------------
GLOBAL.step({ Disable_step_timeoutL: function(ev, sc, st) {
	var rootData = sc.data;
