...
// ----------------------------------------------------------------
GLOBAL.scenario({ carga_SAP_PG: function(ev, sc) {
	...
	sc.step(GLOBAL.steps.pSalirDelSistema_mana_4, null);
}}, ctx.dataManagers.rootData).setId('876a344b-0c1e-4e57-a970-6807d084df32') ;

// ----------------------------------------------------------------
//   Step: getSettingsPG
// ----------------------------------------------------------------
GLOBAL.step({ getSettingsPG: function(ev, sc, st) {
	var rootData = sc.data;
	// Declares a setting
...
//   Step: getFilenamePG
// ----------------------------------------------------------------
GLOBAL.step({ getFilenamePG: function(ev, sc, st) {
	var rootData = sc.data;
...
//   Step: Read_txtPG
// ----------------------------------------------------------------
GLOBAL.step({ Read_txtPG: function(ev, sc, st) {
	var rootData = sc.data;
...
//   Step: setListPG
// ----------------------------------------------------------------
GLOBAL.step({ setListPG: function(ev, sc, st) {
	var rootData = sc.data;
	ctx.workflow('cargaSAP_PG', '5002cf90-9a14-4b40-a00d-c62c773f62c3') ;
	// Genera aarchivo TXT
	sc.endStep(); // Write_txtPG
	return;
}});
...
//   Step: Write_txtPG
// ----------------------------------------------------------------
GLOBAL.step({ Write_txtPG: function(ev, sc, st) {
	var rootData = sc.data;
...
// ----------------------------------------------------------------
GLOBAL.step({ Start_SAPLogon750PG: function(ev, sc, st) {
	var rootData = sc.data;
...
// ----------------------------------------------------------------
GLOBAL.step({ pWindowSAPLogon75_man_4: function(ev, sc, st) {
	var rootData = sc.data;
...
// ----------------------------------------------------------------
GLOBAL.step({ Declare_credentialPG: function(ev, sc, st) {
	var rootData = sc.data;
...
// ----------------------------------------------------------------
GLOBAL.step({ Get_credentialPG: function(ev, sc, st) {
	var rootData = sc.data;
...
// ----------------------------------------------------------------
GLOBAL.step({ pSAPLogin_managementP: function(ev, sc, st) {
	var rootData = sc.data;
...
// ----------------------------------------------------------------
GLOBAL.step({ pSAPEasyAccess_manage_5: function(ev, sc, st) {
	var rootData = sc.data;
...
// ----------------------------------------------------------------
GLOBAL.step({ Disable_step_timeoutP: function(ev, sc, st) {
	var rootData = sc.data;
...
// ----------------------------------------------------------------
GLOBAL.step({ pVentasYFacturasMas_m_5: function(ev, sc, st) {
	var rootData = sc.data;
...
// ----------------------------------------------------------------
GLOBAL.step({ pPosDocumVisualiza_ma_4: function(ev, sc, st) {
	var rootData = sc.data;
...
// ----------------------------------------------------------------
GLOBAL.step({ pVentasYFacturasMas_m_1_4: function(ev, sc, st) {
	var rootData = sc.data;
...
// ----------------------------------------------------------------
GLOBAL.step({ pSAPEasyAccess_manage_1_4: function(ev, sc, st) {
	var rootData = sc.data;
...
// ----------------------------------------------------------------
GLOBAL.step({ pSalirDelSistema_mana_4: function(ev, sc, st) {
	var rootData = sc.data;
