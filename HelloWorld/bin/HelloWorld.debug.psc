...
<ConteXtorStudio Version="Desktop Studio 2.0.7.54" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" noNamespaceSchemaLocation="XsdStudio.xsd">
	<UpdatePackages />
	<Evolutions>
		<Evolution Version="1.0" Date="24/05/2021"><![CDATA[Project creation]]></Evolution>
		<Evolution Version="..." Date="..."><![CDATA[...]]></Evolution>
	</Evolutions>
	<PROCESSUS>
		<PROCESS Name="GLOBAL" Key="NoKey" Comment="Global Processus" CtxtId="bcd03210-d0ba-4736-a214-3f46af5157c7">
			<_DECLAREVAR>
				<STRUCTUREDON Name="GLOBAL">
					<OBJDON Name="PrjVersion">1.0</OBJDON>
					<OBJDON Name="PrjClient"><![CDATA[Test]]></OBJDON>
					<OBJDON Name="PrjName">HelloWorld</OBJDON>
					<OBJDON Name="PrjDate">24/05/2021</OBJDON>
					<OBJDON Name="PrjLabel"><![CDATA[Hola mundo]]></OBJDON>
			...
			<SCRIPTS>
				...
				<SCRIPT Name="Declarations" Src="helloworld.resources.js" ReadOnly="Y" />
		...
		<PROCESS Name="POPUPS" CtxtId="897e0929-652e-4eab-9dc3-de164542d896" Nature="POPUP">
			<SCRIPTS />
			<SCENARII>
				<Steps />
			</SCENARII>
			...
			<_ECRANS />
			<WORKFLOWS>
				<WORKFLOW Name="newWorkflow" Src="%workflows%\newWorkflow.xaml" CtxtId="2a32c222-ad76-4070-8003-5db13554d599" DisplayName="newWorkflow" StepTimeout="30" ScenarioTimeout="600" GeneratedScenarioName="newWorkflow" />
			</WORKFLOWS>
		</PROCESS>
	</PROCESSUS>
	<APPLICATIONS />
	<CONTEXT Id="2348ce7f-9904-4f8b-81de-0aa5668a861f" />
</ConteXtorStudio>