		...
		<PROCESS Name="GLOBAL" Key="NoKey" Comment="Global Processus" CtxtId="978a5bc5-d626-4f38-9291-82fb52fd8170">
			<_DECLAREVAR>
				<STRUCTUREDON Name="GLOBAL">
					<OBJDON Name="PrjVersion">1.31</OBJDON>
			...
			<SCRIPTS>
				...
				<SCRIPT Name="Declarations" Src="cargaventas.resources.js" ReadOnly="Y" />
				<SCRIPT Name="Labels" Src="labels.js" />
				<SCRIPT Name="Global" Src="global.js" />
				<SCRIPT Name="cargaVentasD" Src="cargaventasd.js" IsWorkflowGenerated="Y" />
				<SCRIPT Name="cargaVentas48" Src="cargaventas48.js" IsWorkflowGenerated="Y" />
				<SCRIPT Name="cargaVentasM" Src="cargaventasm.js" IsWorkflowGenerated="Y" />
			</SCRIPTS>
			<RESOURCES>
